...
def visualize_portfolio(portfolio, tickers):
    """
    param: portfolio (episode_length, num_stocks + 1)
            episode_length can be shorter if you don't want to visualize the entire episode

    pass in state[1][i], the portfolio of shape (model.num_stocks+1,) in the i'th time step
    """
